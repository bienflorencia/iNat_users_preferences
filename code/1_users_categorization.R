...
# we need to detect those users that are not from Uruguay and remove
# the data generated by them from our dataset
...
# left_join(natuy_data, uruguayans %>% select(user_login, 
#                                             observations_NatUY, 
#                                             observations_iNat,
#                                             uruguayan), by='user_login')
